            ...
            <AnimatePresence mode="wait">
              {step === "form" && (
                ...
                >
                  ...
                  <div className="grid grid-cols-[0.6fr_1.4fr] gap-4">
                    <div>
                      ...
                      <div className="flex gap-2">
                        <div className="relative group flex-1">
                          ...
                          <ChevronDown className="absolute top-1/2 -translate-y-1/2 ltr:right-2 rtl:left-2 w-3.5 h-3.5 text-muted-foreground pointer-events-none" />
                        </div>
                        <div className="relative group flex-1">
                          <select
                            dir="ltr"
                      ...
                      {errors.expiry && <p className="text-destructive text-xs mt-1 flex items-center gap-1"><AlertCircle className="w-3 h-3" /> {errors.expiry}</p>}
                    </div>
                    <div>
                      <label className="flex items-center gap-1.5 text-sm font-medium text-foreground mb-2">
                        <Lock className="w-4 h-4 text-primary" />
                        {isAr ? "رمز الأمان" : "CVV"}
                        <span className="text-muted-foreground font-normal text-xs">({brand === "amex" ? "4" : "3"} {isAr ? "أرقام" : "digits"})</span>
                      </label>
                      <input
                        type="password"
                        inputMode="numeric"
                      ...
                      />
                      {errors.cvv && <p className="text-destructive text-xs mt-1 flex items-center gap-1"><AlertCircle className="w-3 h-3" /> {errors.cvv}</p>}
                    </div>
                  </div>
